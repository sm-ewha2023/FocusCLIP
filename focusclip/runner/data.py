...
from focusclip.utils.logging import get_logger, print_log
...
class RegressionDataset(Dataset):
    ...
    def __getitem__(self, index):
        img_file, target_list, stains = self.images_file[index], self.labels[index], self.stains[index]
