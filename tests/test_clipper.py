...
from focusclip.models.focusclip import FocusCLIP, load_clip_to_cpu
from focusclip.models.prompt_leaners import PROMPT_LEARNERS
from focusclip.models.prompt_leaners.rank_prompt_learner import RankPromptLearner
...
def test_clipper():
    ...
    model = FocusCLIP(**OmegaConf.to_container(cfg))
